...
| <tt>OWNER_CHECKER_ALLOW_UNOWNED_PATTERNS</tt> | - | 	Specifies whether CODEOWNERS may have unowned files. For example: <br> <br>  /infra/oncall-rotator/                    @sre-team <br>  /infra/oncall-rotator/oncall-config.yml <br> <br>  The `/infra/oncall-rotator/oncall-config.yml` file is not owned by anyone.                                                                                                                                                                                           |
